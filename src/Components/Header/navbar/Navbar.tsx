...
const Navbar = () => {
    ...
    return (
        <>
            <nav id="header">
                <div className="fixed z-10 w-full px-4 flex items-center justify-between py-1">
                                    ...
                                    <div className="hidden lg:block absolute right-0 mt-2 w-54 rounded-[20px] border border-gray-200 bg-white shadow-lg overflow-hidden z-50">
                                        ...
                                        >
                                            <svg className='flex items-center justify-center w-6 h-6' viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                ...
                                                <path d="M20.0007 11.25C18.4601 11.25 17.0671 11.8273 16.0773 12.8766C15.0874 13.9258 14.5929 15.3766 14.7046 16.9336C14.9312 20 17.307 22.5 20.0007 22.5C22.6945 22.5 25.0656 20 25.2968 16.9344C25.4124 15.3922 24.9218 13.9547 23.9156 12.8859C22.9218 11.8313 21.5312 11.25 20.0007 11.25Z" fill="#0F172A" />
                                            </svg>
                            ...
                            <div className="lg:hidden absolute top-full z-50 left-3 right-3 mt-2 rounded-[10px] py-3 px-5 bg-gray-50 border border-gray-200 " onClick={() => setIsSidebarMobileOpen(false)}>
                                ...
                                <div className='flex flex-row items-center'>
                                    <ul className='w-full'>
                                        ...
                                        <li className='flex flex-col my-2 relative w-full'>
                                            <a className='flex items-center px-2 py-5 ' href='/'>
